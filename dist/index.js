...
var Email = /*#__PURE__*/function (_Component) {
    ...
    if (this.props.value.length > 1) {
      for (var i = 0; i <= this.props.value.length - 1; i++) {
        if (i !== this.props.index) {
          if (this.props.value[i].email === this.props.value[this.props.index].email) {
  ...
  _proto.render = function render() {
    ...
    }), /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(React__default.Fragment, {
      className: "add-remove"
    }, /*#__PURE__*/React__default.createElement("span", null, /*#__PURE__*/React__default.createElement("i", {
      className: "fa fa-minus",
      "aria-hidden": "true"
    }))), this.props.isShowPlus ? /*#__PURE__*/React__default.createElement("i", {
      className: "fa fa-plus",
      "aria-hidden": "true",
      onClick: this.onMultipleAdd.bind(this)
    }) : ""), this.state.isInvalidEmail ? /*#__PURE__*/React__default.createElement("div", {
      className: "error-msg"
    }, this.props.emailFormateError) : "", this.state.isDuplicateEmail ? /*#__PURE__*/React__default.createElement("div", {
      className: "error-msg"
...
Email.defaultProps = {
  ...
  onMultipleEmail: function onMultipleEmail() {},
  placeholder: "",
  id: "",
  name: "",
  tabIndex: 0,
